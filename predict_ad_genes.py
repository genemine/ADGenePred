...
times=100
data=pd.read_csv('data/mat_training.txt',index_col=0,header=0,sep='\t')
data_pred=pd.read_csv('data/mat2pred.txt',index_col=0,header=0,sep='\t')
...
pred.to_csv('data/prediction.txt',sep='\t')
